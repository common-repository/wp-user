...
if (!class_exists('wpuserAjaxgroups')) :
    ...
    class wpuserAjaxgroups
    {
        ...
        function wpuser_add_group()
        {
          ...
          */
            ...
            if ($user_id) {
                ...
                $wpuser_group_arr = isset( $_POST['wpuser'] ) ? (array) $_POST['wpuser'] : array();
                $wpuser_group = $this->recursive_sanitize_text_field( $wpuser_group_arr );
        ...
        function wpuser_update_group()
        {
            ...
            $group_id = sanitize_text_field( $_POST['update_group_id'] );
        ...
        function wpuser_listgroups()
        {
            ...
            if ($user_id) {
                $wpuser_group_type = strtolower(str_replace(' ', '_', sanitize_text_field( $_POST['type']) ));
        ...
        function wpuser_group_action()
        {
            ...
            global $wpdb;
            $group_id= sanitize_text_field( $_POST['id'] );
            $user_id = get_current_user_id();
        ...
        function wpuser_getGrouprList()
        {
            ...
            $per_page = ((isset($_POST['per_page']) && !empty($_POST['per_page']))) ? sanitize_text_field( $_POST['per_page'] ): 10;
        ...
        <div class="box box-primary wpuser-custom-box">
            <div class="box-body box-profile">
                ...
                <p class="text-muted text-center"><i class="fa fa-unlock"></i> ' . ucfirst(sanitize_text_field($group['visibility'])) . ' Group</p>                          
           </div>
