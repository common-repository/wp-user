                                ...
                                <div class="col-md-9">
                                    <div class="input-group input-group-sm user_meta_image">
                                        <input type="text" name="wp_user_appearance[form_header][background_image]"
                                               ...
                                               value="<?php echo (isset($wp_user_appearance['form_header']['background_image']) && !empty($wp_user_appearance['form_header']['background_image'])) ? esc_url($wp_user_appearance['form_header']['background_image']) : '' ?>"
                                               class="form-control"/>
