            ...
            <div class="box-header with-border">
              <h3 class="box-title"><button class="btn" title="drag tab for change order"> <i class="'.$tab_icon.'"> </i> </button> ';
                ...
                if((isset($tab['tab_visible_role']) && !empty($tab['tab_visible_role'])) || (isset($tab['tab_visible_role_edit_level']) && !empty($tab['tab_visible_role_edit_level']))){
                    $tab_visible_role_view = (isset($tab['tab_visible_role']) && !empty($tab['tab_visible_role'])) ?  (array) $tab['tab_visible_role']: array();
                    $tab_visible_role_view_level = (isset($tab['tab_visible_role_edit_level']) && !empty($tab['tab_visible_role_edit_level'])) ? (array) $tab['tab_visible_role_edit_level'] : array();
                ...
                if((isset($tab['tab_visible_role_view']) && !empty($tab['tab_visible_role_view'])) || (isset($tab['tab_visible_role_view_level']) && !empty($tab['tab_visible_role_view_level']))){
                    $tab_visible_role_view = (isset($tab['tab_visible_role_view']) && !empty($tab['tab_visible_role_view'])) ? (array) $tab['tab_visible_role_view']: array();
                    $tab_visible_role_view_level = (isset($tab['tab_visible_role_view_level']) && !empty($tab['tab_visible_role_view_level'])) ? (array) $tab['tab_visible_role_view_level'] : array();
                    $tab_visible = implode(',', array_merge($tab_visible_role_view, $tab_visible_role_view_level) );
                    $html .= '
