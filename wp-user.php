    ...
    final class WPUser
    {
        ...
        function my_plugin_install_function()
        {
            ...
            if (empty($wp_user_page)) {
                $post = array('comment_status' => 'closed', 'ping_status' => 'closed', 'post_author' => 1, 'post_date' => date('Y-m-d H:i:s'), 'post_name' => 'User', 'post_status' => 'publish', 'post_title' => 'User', 'post_content' => '[wp_user]', 'post_type' => 'page',);
