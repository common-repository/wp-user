        ...
        <div class="col-md-12">
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                                                ...
                                                <div class="form-group row row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <?php if (!empty($field['help_description'])) {
                                                            echo '<br><a href="' . esc_url( $field['help_link'] ). '">' . esc_html( $field['help_description'] ). '</a>';
                                                        } ?>
                                                    </div>
                                        ...
                                        <div class="form-group row row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <a title="User" id="wp_user_page_permalink" target="_blank"
                                                   href="<?php echo esc_url( $wp_user_page_permalink )?>">
                                                    <button type="button"
                                        ...
                                        <div class="form-group row row">
                                            ...
                                            <div class="col-md-3">
                                                <a title="Members" target="_blank" id="wp_user_member_page_permalink"
                                                   href="<?php echo esc_url( $wp_user_member_page_permalink )?>">
                                                    <button type="button"
                                                            class="btn btn-block btn-default btn-flat ng-binding"><?php _e('View Page', 'wpuser') ?></button>
                                                </a>
                                            </div>
                                        ...
                                        <div class="box-body">
                                            ...
                                            if (!empty($options_general['help_description'])) {
                                                ...
                                                <div class="alert alert-info alert-dismissible">
                                                    ...
                                                    <?php echo wp_kses_post( $options_general['help_description'] )?>
                                                </div>
                                                <?php
                                            }
                    ...
                    if(!empty($wpuser_admin_setting_tab)) {
                        foreach ($wpuser_admin_setting_tab as $tab => $setting_tab) {
                            echo '<div class="tab-pane ' . esc_attr( $setting_tab['active'] ). '" id="' . esc_attr($tab) . '">                                    ';
