                                    ...
                                    <div id="tab_1" class="tab-pane active">
                                            ...
                                            <div class="col-xs-12">
                                                <h2 class="page-header">
                                                    ...
                                                    <small
                                                        ...
                                                        <a target="_blank" href="<?php echo esc_url(WPUSER_PRO_URL) ?>">
                                                                        ...
                                                                        <div class="clearfix">
                                                                            <p class="pull-right">
                                                                                <?php if (is_plugin_active($addon['addon_path'])) {
                                                                                    ...
                                                                                    echo '<a target="_blank" style="color:#fff" href="' .esc_url( $addon['addon_url_buy'] ). '" class="btn btn-block btn-primary addon-btn btn-flat">';
                                                                                    _e('Buy Now', 'wpuser');
                                                                                    echo '</a>';
                                                                                } ?>
                                                                            ...
                                                                            <a target="_blank"
                                                                               href="<?php echo esc_url($addon['addon_url']) ?>"
                                                                               class="ad-click-event"><h4
                                                                                    style="margin-top: 0"><?php echo esc_attr($addon['addon_name']) ?></h4>
                                                                            </a>
                                        ...
                                        <div class="addon-footer">
                                            <div class="pull-right hidden-xs">
                                                <a target="_blank" href="<?php echo esc_url(WPUSER_SUPPORT_URL) ?>"> <i
                                            ...
                                            <?php if (count($addons) != ($installed_count) && WPUSER_TYPE=='FREE') { ?>
                                                <h4><strong>Get All <a target="_blank"
                                                                       href="<?php echo esc_url(WPUSER_PRO_URL) ?>">Pro
                                                            Feature</a> (All
                                                        Add-ons).</strong> <?php echo esc_attr(WPUSER_COUPON) ?></h4>
                                            <?php } else {
