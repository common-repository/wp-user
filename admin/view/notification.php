...
if ($notification_count > 0) {
    ...
    <li class="dropdown notifications-menu">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
            ...
            <span class="label label-warning"><?php echo esc_attr($notification_count) ?></span>
        </a>
        <ul class="dropdown-menu">
            <li class="header"><?php _e('You have ' . esc_attr($notification_count) . ' notifications', 'wpuser') ?></li>
            <li>
                ...
                <ul class="menu">
                    ...
                    <li>
                    <a href="#">
                        <i class="' . esc_attr($notification['icon']) . '"></i> ' . esc_attr($notification['notification']) . '
                    </a>
                    </li>';
                    } ?>
                </ul>
