                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                ...
                                <li><!-- Task item -->
                                    <a target="_blank"
                                       href="<?php echo esc_url(WPUSER_PRO_URL) ?>"> WP User Pro version.
                                        <h3>
                                            <small class="pull-right">Buy</small>
                                        </h3>
                                    </a>
...
<span class="dashicons dashicons-admin-users"></span><?php _e(' Wp User', 'upuser') ?></span>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            <a target="_blank" href="https://www.wpseeds.com/product/wp-user-custom-registration-forms-login-and-user-profile/"><img
                                    src="<?php echo esc_url(WPUSER_PLUGIN_URL) ?>assets/images/wpseedslogo.png"
                        ...
                        <li class="user-body">
                            <a target="_blank"
                               href="<?php echo esc_url(WPUSER_PRO_URL) ?>">Get WP User Pro
                                Feature</a>
                        </li>
