                                                    ...
                                                    <div class="page" id="demo">
                                                        ...
                                                        <div class="row list">
                                                            ...
                                                            foreach ($blogusers as $user) {
                                                                ...
                                                                echo '</span></div>';
                                                                echo '<div class="col-md-2" ><span class="name "><a href="'.esc_url($genre_url).'" target="_blank">' . esc_html($user->display_name) . '</a></span></div>';
                                        ...
                                        <div class="page" id="login_log">
                                            ...
                                            <div class="row list-login">
                                                ...
                                                foreach ($data as $login_data) {
                                                    ...
                                                    echo '<div class="col-md-3 "><span class="user_email ' . ucfirst(esc_attr($login_data->user_email)) . '">' . ucfirst(esc_attr($login_data->user_email)) . '</span></div>';
