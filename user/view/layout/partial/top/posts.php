<div class="wpuser_posts" id="wpuser_posts">
  <div class="row">
    ...
    $user_id = (isset($_GET['user_id']) && !empty($_GET['user_id'])) ? sanitize_text_field( $_GET['user_id'] ): $current_user->ID;
      ...
      while($post_query->have_posts() ) {
        ...
        <a href="/docs/4.1/examples/album/">
          <?php if ( has_post_thumbnail() ) {
            ...
            ?>
          <img class="img-thumbnail mb-3" src="<?php echo  esc_url( $post_thumbnail )?>" alt="Album screenshot" width="960" height="600">
