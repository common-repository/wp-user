...
class WPUserMyProfile
{
        ...
        <div class="panel panel-default">
          ...
          <div id="my_accout_collapse' . esc_attr( $key ). '" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
            ...
            foreach ($array['fields'] as $key => $value) {
                ...
                $textValue = ( 'array' == gettype($textValue)) ?implode( ',', $textValue ) : $textValue;
    ...
    static function edit_profile($atts = array())
    {
        global $wpdb;
        global $current_user, $wp_roles, $wp_user_appearance_button_type;
        $layout = (isset($atts['layout']) && !empty($atts['layout'])) ? $atts['layout'] :
        ...
        if (isset($atts['id']) && !empty($atts['id'])) {
            ...
            if ($userplus_field_order) {
                ...
                for ($i = 0; $i < $fields_count; $i++) {
                    ...
                    $array = $form_fields[$key];
                    if ($key != 'user_login')
                        echo profileController::edit_fields($key, $array, $layout, $form_id, $user_id);
            ...
            foreach ($wp_user_options_my_profile_form as $array) {
                echo profileController::edit_fields($array['meta_key'], $array, $layout, $form_id, $user_id);
            }
        }
        ...
        <div class="nav-tabs-custom group_list">
            ...
            <ul class="nav nav-tabs">
              ...
              <li class=""><a href="#tab_find_groups" data-toggle="tab" aria-expanded="false" onclick="getGrouprList('1')">Find Groups</a></li>
                <li class="pull-right">
                <?php
                echo '<label id="wp_user_profile_add_group" class="wpuser_button wp_user_profile_add_group btn ' . esc_attr($wp_user_appearance_button_type) . ' btn-primary wpuser-custom-button">';
                  ...
                  <div class="box box-default collapsed-box">
                      ...
                      <div class="box-body" style="display: none;">
                          <form name="wpuser_filter_form" id="wpuser_filter_form">
                              ...
                              <div class="col-md-12">
                                  <a class="pull-right" calss="advance_filter" data-toggle="collapse" href="#collapseFilter" aria-expanded="false" aria-controls="collapseExample">
