...
class wpuserSearchwidget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(// Base ID of your widget
            'wpuserSearchwidget', // Widget name will appear in UI
            __('WP-User : Search Users', 'wp-user'), // Widget description
    ...
    public function form($instance)
    {
        ...
        <p>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('wp_user_form_id')); ?>"
                   name="<?php echo esc_attr($this->get_field_name('wp_user_form_id')); ?>" placeholder="Enter Form id"
                   type="text"
                   value="<?php echo esc_attr(esc_attr($wp_user_form_id)); ?>"/>
            <label
                    for="<?php echo esc_attr($this->get_field_id('wp_user_form_id')); ?>"><?php _e('Enter Form Id for custom search field'); ?></label>
        </p>
        <?php
    }
