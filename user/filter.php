                        ...
                        <div class="">
                            <?php if (!empty($notifications_menu)) {
                                foreach ($notifications_menu as $menu) {
                                    echo '<a target="_blank" href="' . esc_url( $menu['url'] ). '" class="sidebar-toggle"> ' . esc_attr( $menu['name'] ). '</a>';
                                }
                            }
                            ?>
                        ...
                        <div  class="navbar-right" style="margin-right: 0px;">
                            ...
                            <ul class="nav navbar-nav">
                                                ...
                                                <div class="slimScrollDiv"
                                                    ...
                                                    <ul class="menu"
                                                        ...
                                                        <?php foreach ($notifications as $notification) {
                                                            ...
                                                            echo '
                                                <li class="'.esc_attr($notification_call).' alert-dismissible notification notification_' .esc_attr( $notification['id'] ).'" onclick="readNotification(' .esc_attr($notification['id']) .')">
                                ...
                                <li class="dropdown user user-menu wpuser-custom-header-user">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                        <img src="<?php echo esc_url( $wp_user_profile_img )?>"
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="user-footer">
                                            <div class="pull-left">
                                                ...
                                                ?>
                                                <a href="<?php echo esc_url( $wp_user_page_permalink ) ?>"
...
function wpuser_action_view_profile_sidebar_header_info($user_id){
    ...
    if( !empty($phone) && $phone !=0 ){
      $phone = apply_filters('wpuser_profile_field_phone', $phone );
        echo '<p><a href="tel:+'.esc_attr( $phone ).'"><i class="fa fa-phone margin-right-15"></i> '.esc_attr( $phone ).'</a></p>';
    }
...
function wpuser_action_view_profile_sidebar($user_id){
    ...
    if(!empty($facebook)){
        echo '<a href="'.esc_url( $facebook ).'" target="_blank" class="wpuser_facebook" id="">
